...
window.AGENT_SIDEBAR_NAV_HTML = `<div class="nav-group" data-nav-zone="main">
  ...
  <ul class="nav-group__list">
    <li class="nav-item"><a href="{{BASE}}agent/" class="nav-link" data-nav="home"><i data-lucide="house"></i><span class="nav-link-text">หน้าแรก</span></a></li>
  </ul>
</div>
<div class="nav-group" data-nav-zone="finance">
  <p class="nav-group__title">การเงิน</p>
  <ul class="nav-group__list">
    <li class="nav-item"><a href="{{BASE}}agent/commission" class="nav-link" data-nav="commission"><i data-lucide="coins"></i><span class="nav-link-text">ค่าคอมมิชชัน</span></a></li>
    <li class="nav-item"><a href="{{BASE}}agent/withdraw" class="nav-link" data-nav="withdraw"><i data-lucide="banknote"></i><span class="nav-link-text">แจ้งถอนเงิน</span></a></li>
    <li class="nav-item"><a href="{{BASE}}agent/wht50" class="nav-link" data-nav="wht50"><i data-lucide="file-badge"></i><span class="nav-link-text">หนังสือ 50 ทวิ</span></a></li>
    <li class="nav-item"><a href="{{BASE}}agent/credit" class="nav-link" data-nav="credit"><i data-lucide="wallet"></i><span class="nav-link-text">ขอเติมวงเงิน</span></a></li>
    <li class="nav-item"><a href="{{BASE}}agent/credit-history" class="nav-link" data-nav="credit-history"><i data-lucide="history"></i><span class="nav-link-text">ประวัติการเติมเงิน</span></a></li>
  </ul>
</div>
  ...
  <ul class="nav-group__list">
    <li class="nav-item has-submenu" data-nav-group="compulsory">
      ...
      <ul class="nav-submenu">
        <li><a href="{{BASE}}compulsory/ergo" class="nav-sub-link" data-nav="compulsory-ergo"><img src="{{BASE}}assets/logos/ergo.png" alt="เออร์โกประกันภัย" class="sub-logo-img"><span class="nav-sub-link-label"><span>เออร์โกประกันภัย</span></span></a></li>
        ...
        <li><a href="#" class="nav-sub-link" data-nav="compulsory-chubb"><img src="{{BASE}}images/partners/chubb.jpg" alt="CHUBB" class="sub-logo-img"><span class="nav-sub-link-label"><span>CHUBB</span></span></a></li>
        <li><a href="#" class="nav-sub-link" data-nav="compulsory-indara"><img src="{{BASE}}assets/logos/indara.png" alt="อินทรประกันภัย" class="sub-logo-img"><span class="nav-sub-link-label"><span>อินทรประกันภัย</span></span></a></li>
      </ul>
    </li>
    ...
    <li class="nav-item has-submenu" data-nav-group="pa">
      ...
      <ul class="nav-submenu">
        <li><a href="#" class="nav-sub-link" data-nav="pa-axa"><img src="{{BASE}}images/partners/axa.jpg" alt="AXA" class="sub-logo-img"><span class="nav-sub-link-label"><span>AXA</span></span></a></li>
        <li><a href="{{BASE}}pa/bki" class="nav-sub-link" data-nav="pa-bki"><img src="{{BASE}}images/partners/bangkok-insurance.jpg" alt="BKI กรุงเทพประกันภัย" class="sub-logo-img"><span class="nav-sub-link-label"><span>BKI กรุงเทพ</span></span></a></li>
      </ul>
    </li>
    ...
    <li class="nav-item"><a href="{{BASE}}agent/renew" class="nav-link" data-nav="renew"><i data-lucide="refresh-cw"></i><span class="nav-link-text">ต่ออายุ กธ.</span><span class="nav-badge">renew</span></a></li>
  </ul>
</div>
<div class="nav-group" data-nav-zone="reports">
  ...
  <ul class="nav-group__list">
    <li class="nav-item has-submenu" data-nav-group="reports">
      ...
      <ul class="nav-submenu">
        <li><a href="{{BASE}}agent/reports/daily-policies" class="nav-sub-link" data-nav="reports-daily-policies"><i data-lucide="clipboard-list" class="nav-sub-icon"></i><span>ขายกรมธรรม์ประจำวัน</span></a></li>
        <li><a href="{{BASE}}agent/reports/daily-summary" class="nav-sub-link" data-nav="reports-daily-summary"><i data-lucide="bar-chart-3" class="nav-sub-icon"></i><span>สรุปการขายประจำวัน</span></a></li>
        <li><a href="{{BASE}}agent/reports/monthly" class="nav-sub-link" data-nav="reports-monthly"><i data-lucide="calendar-range" class="nav-sub-icon"></i><span>รายงานรายเดือน</span></a></li>
        <li><a href="{{BASE}}agent/reports/team" class="nav-sub-link" data-nav="reports-team"><i data-lucide="users-round" class="nav-sub-icon"></i><span>รายงานลูกทีม</span></a></li>
      </ul>
    </li>
...
<div class="nav-group" data-nav-zone="receipt">
  ...
  <ul class="nav-group__list">
    <li class="nav-item has-submenu" data-receipt-nav data-nav-group="receipt">
      ...
      <ul class="nav-submenu">
        <li><a href="{{BASE}}agent/receipt/issue" class="nav-sub-link" data-receipt-page="issue" data-nav="receipt-issue"><i data-lucide="printer" class="nav-sub-icon"></i><span>ออกใบเสร็จ</span></a></li>
        <li><a href="{{BASE}}agent/receipt/inquiry" class="nav-sub-link" data-receipt-page="inquiry" data-nav="receipt-inquiry"><i data-lucide="search" class="nav-sub-icon"></i><span>สอบถามข้อมูล</span></a></li>
        <li><a href="{{BASE}}agent/receipt/daily-summary" class="nav-sub-link" data-receipt-page="daily-summary" data-nav="receipt-summary"><i data-lucide="bar-chart-2" class="nav-sub-icon"></i><span>สรุปประจำวัน</span></a></li>
        <li><a href="{{BASE}}agent/receipt/daily-detail" class="nav-sub-link" data-receipt-page="daily-detail" data-nav="receipt-detail"><i data-lucide="list" class="nav-sub-icon"></i><span>รายละเอียดประจำวัน</span></a></li>
        <li><a href="{{BASE}}agent/receipt/settings" class="nav-sub-link" data-receipt-page="settings" data-nav="receipt-settings"><i data-lucide="file-pen" class="nav-sub-icon"></i><span>ตั้งค่าใบเสร็จ</span></a></li>
      </ul>
    </li>
  </ul>
</div>
<div class="nav-group" data-nav-zone="team">
  ...
  <ul class="nav-group__list">
    <li class="nav-item"><a href="{{BASE}}agent/team" class="nav-link" data-nav="team"><i data-lucide="users"></i><span class="nav-link-text">ลูกทีม</span></a></li>
  </ul>
</div>`;

window.AGENT_SIDEBAR_NAV_VERSION = '20260909b';

  ...
  <ul class="nav-group__list">
    ...
    <li class="nav-item has-submenu" data-nav-group="pa">
      ...
      <ul class="nav-submenu">
        ...
        <li><a href="#" class="nav-sub-link" data-nav="pa-bki"><img src="{{BASE}}images/partners/bangkok-insurance.jpg" alt="BKI กรุงเทพประกันภัย" class="sub-logo-img"><span class="nav-sub-link-label"><span>BKI กรุงเทพ</span></span></a></li>
      </ul>
    </li>
...
window.AGENT_SIDEBAR_NAV_VERSION = '20260906b';
